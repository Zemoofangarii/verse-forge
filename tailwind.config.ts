...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-primary": "linear-gradient(135deg, hsl(var(--primary)), hsl(200 100% 45%))",
        "gradient-secondary": "linear-gradient(135deg, hsl(var(--secondary)), hsl(280 100% 60%))",
      ...
      boxShadow: {
        ...
        "glow": "0 4px 30px hsl(var(--primary) / 0.3)",
